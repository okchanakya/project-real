...
jQuery(document).ready(function ($) {
  ...
  $(document).on("submit", "#messenger", function (e) {
    ...
    function userMsg(msg) {
      $('.messages_list').append('<div class="message new message-personal"><span class="avatar"><img src="https://mrseankumar25.github.io/Sandeep-Kumar-Frontend-Developer-UI-Specialist/images/avatar.png" /></span><span class="responsText">' + mainval + '</span></div>');
    };
    function appendMsg(msg) {    
      $('.messages_list').append('<div class="msg message new"><span class="avatar"><figure style="background-image: url(https://mrseankumar25.github.io/Sandeep-Kumar-Frontend-Developer-UI-Specialist/images/avatar.png)"></figure></span><span class="responsText">' + msg + '</span></div>');
      $("[name='msg']").val("");
    };
    ...
    if (val.indexOf("hello") > -1 || val.indexOf("hi") > -1 || val.indexOf("good morning") > -1 || val.indexOf("good afternoon") > -1 || val.indexOf("good evening") > -1 || val.indexOf("good night") > -1) {
      ...
      appendMsg("what's you name <ul><li>sdfsd</li><ul>?");
